...
class Solution {
    void getWrongNodes(Node* root, Node*& first, Node*& middle, Node*& last, Node*& prev){
        if(root == nullptr) 
            return;
        getWrongNodes(root -> left, first, middle, last, prev);
        ...
        prev = root;
        getWrongNodes(root -> right, first, middle, last, prev);
    }
  public:
    void correctBST(Node* root) {
        // Q. Fixing Two nodes of a BST
        // add code here.
        Node *first = nullptr, *middle = nullptr, *last = nullptr, *prev = nullptr;
        getWrongNodes(root, first, middle, last, prev);
        if(first && last){
